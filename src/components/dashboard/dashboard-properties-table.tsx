...
export function DashboardPropertiesTable() {
  ...
  function handleDelete(propertyId: string) {
    const confirmed = window.confirm("¿Eliminar esta propiedad?");
    ...
    return (
      <div className="rounded-2xl border border-dashed border-border bg-card p-14 text-center">
        ...
        <p className="mx-auto mt-3 max-w-md text-muted-foreground">
          Publica tu primera propiedad para comenzar a recibir solicitudes y
          administrar arrendamientos.
        </p>
          ...
          <tbody>
            {properties.map((property) => (
              ...
              >
                ...
                <td className="px-8 py-6">324</td>

                <td className="px-8 py-6">
                  <div className="flex items-center justify-end">
                    <DropdownMenu>
                      <DropdownMenuTrigger className="rounded-xl border border-border p-2 transition-all hover:bg-muted">
